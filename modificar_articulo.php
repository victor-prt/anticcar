<?php
	...
	$issn = mysql_real_escape_string(strtolower($_POST['issn']));
	...
	{
		case 0:
			$insert = "UPDATE tbl_articulos SET titulo = '".$titulo."' , subtitulo = '".$subtitulo."' ,localizacion = '".$localizacion."', publicacion = '".$publicacion."', coleccion = '".$coleccion."', isbn ='".$isbn."', id_idioma = '".$idioma."',  id_materia = '".$materia."', marca ='".$marca."', modelo = '".$modelo."', descripcion = '".$descripcion."', autor ='".$autor."', deposito_legal = '".$deposito."', tipo_documento = '".$tipodoc."', numero='".$numero."', ano='".$ano."', id_periodicidad ='".$periodicidad."', issn ='".$issn."', contenido='".$contenido."' WHERE id_articulo = ".$id;
